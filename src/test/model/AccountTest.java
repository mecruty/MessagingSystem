...
public class AccountTest {
    ...
    public void testSettingFields() {
        ...
        testAccount.setConversations(Map.of(testAccount2, new Conversation()));
        assertEquals(testAccount.getName(), "Charles");
        assertEquals(testAccount.getPassword(), "3456");
        assertEquals(testAccount.getConversations(), Map.of(testAccount2, new Conversation()));
    }
    ...
    public void testReadConversation() {
        ...
        assertEquals(testAccount.readConversation(testAccount2, 1, 0), message1);
